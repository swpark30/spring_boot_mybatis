...
public class FileUploadController {
	...
	public String viewFileUpload(@RequestParam("uploadFile") MultipartFile file, Model model) throws IOException{
		...
		String uploadPath = "D:/IT_class/Web/springWorkspace/upload/";
	...
	public String viewFileUploadMultipel(@RequestParam("uploadFileMulti") ArrayList<MultipartFile> files, Model model) throws IOException{
		// 1. 파일 저장 경로 설정 : 실제 서비스되는 위치 (프로젝트 외부에 저장)
		String uploadPath = "D:/IT_class/Web/springWorkspace/upload/";
